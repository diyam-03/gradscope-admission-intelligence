...
# Use real ML model if available, otherwise fallback formula
if USE_ML:
    chance = predict_chance(gre, toefl, cgpa, sop, lor, uni_r, rv)
else:
...
with right:
    ...
    model_label = "ML Model" if USE_ML else "Formula estimate"
    ...
    <div class="gs-result">
      ...
      <div style="font-family:'Fraunces',serif;font-size:5.5rem;font-weight:900;
                  ...
                  line-height:1;margin-bottom:0.7rem;">{chance}%</div>
      <div class="gs-pill gs-pill-{pill}">{lbl}</div>
      <div style="font-size:0.72rem;color:#7b8cb0;margin-top:0.75rem;">{model_label}</div>
    ...
    fig.add_trace(go.Scatterpolar(
        ...
        marker=dict(size=5, color="#c8006e"),
        name="Your Profile"))
    fig.add_trace(go.Scatterpolar(
    ...
    fig.update_layout(
        ...
        font_family="Outfit",
        margin=dict(l=40, r=40, t=20, b=40), height=295)
...
components = {
    "GRE":        ((gre/340)*100,    100),
    "CGPA":       ((cgpa/10)*100,    100),
    "SoP":        ((sop/5)*100,      100),
    "LoR":        ((lor/5)*100,      100),
    "TOEFL":      ((toefl/120)*100,  100),
    "Uni Rating": ((uni_r/5)*100,    100),
    "Research":   (rv*100,           100),
}
    ...
    with col:
        ...
        <div style="text-align:center;padding:0.8rem 0.4rem;
          ...
          <div style="font-family:'Outfit',sans-serif;font-size:0.62rem;font-weight:700;
                      letter-spacing:0.08em;text-transform:uppercase;color:#7b8cb0;
          ...
          <div style="font-family:'Fraunces',serif;font-size:1.35rem;font-weight:900;
                      ...
                      line-height:1;">{earned:.0f}%</div>
          <div style="margin-top:0.4rem;background:rgba(13,27,62,0.08);
...
if rv == 0:    tips.append(("Research",     "#f5a623", "Students with research experience have higher admit rates."))
        ...
        with col:
            ...
            <div style="background:rgba(255,255,255,0.78);border:1px solid rgba(255,255,255,0.90);
              ...
              <div style="font-family:'Outfit',sans-serif;font-size:0.72rem;font-weight:700;
                          letter-spacing:0.08em;text-transform:uppercase;color:{c};
                          margin-bottom:0.4rem;">{area}</div>
